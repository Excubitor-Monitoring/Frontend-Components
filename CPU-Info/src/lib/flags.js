export const flag_codes = {
    ...
    "AMD_LBR_V2": "AMD Last Branch Record Extension Version 2",
    ...
    "SGX_EDECCSSA": "SGX EDECCSSA user leaf function",
    "CALL_DEPTH": "Call depth tracking for RSB stuffing",
    "MSR_TSX_CTRL": "MSR IA32_TSX_CTRL (Intel) implemented",
    "SMBA": "Slow Memory Bandwidth Allocation",
    "BMEC": "Bandwidth Monitoring Event Configuration",
    "AVX_VNNI": "AVX VNNI instructions",
    "AVX512_BF16": "AVX512 BFLOAT16 instructions",
    "CMPCCXADD           ": "CMPccXADD instructions",
    "ARCH_PERFMON_EXT": "Intel Architectural PerfMon Extension",
    "FZRM": "Fast zero-length REP MOVSB",
    "FSRS": "Fast short REP STOSB",
    "FSRC": "Fast short REP {CMPSB,SCASB}",
    "LKGS": "Load kernel (userspace) GS",
    "AMX_FP16": "AMX fp16 Support",
    "AVX_IFMA            ": "Support for VPMADD52[H,L]UQ",
    ...
    "AMD_PSFD            ": "Predictive Store Forwarding Disable",
    ...
    "NO_NESTED_DATA_BP": "No Nested Data Breakpoints",
    "LFENCE_RDTSC": "LFENCE always serializing / synchronizes RDTSC",
    "NULL_SEL_CLR_BASE": "Null Selector Clears Base",
    "AUTOIBRS": "Automatic IBRS",
    "NO_SMM_CTL_MSR": "SMM_CTL MSR is not present",
    }